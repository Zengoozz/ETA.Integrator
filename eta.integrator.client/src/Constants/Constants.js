...
const SettingsValidationRules = {
   clientId: [
      ...
      { whitespace: true, message: "Client ID cannot be empty spaces" },
   ],
   clientSecret: [
   ...
   issuerName: [
      ...
      { whitespace: true, message: "Issuer name cannot be empty spaces" },
   ],
   registrationNumber: [
   ...
   governorate: [{ required: true, message: "Please select your governorate!" }],
   region: [{ required: true, message: "Please select your region!" }],
   branchId: [
      { required: true, message: "Please input your branch id!" },
      { whitespace: true, message: "branch id cannot be empty spaces" },
   ],
   buildingNumber: [
      { required: true, message: "Please input your building number!" },
      { whitespace: true, message: "building number cannot be empty spaces" },
   ],
   streetInfo: [
      { required: true, message: "Please input your street information!" },
      { whitespace: true, message: "street information cannot be empty spaces" },
   ],
};
